...
class FileModificationNotifierImpl : public FileModificationNotifier {
   public:
    FileModificationNotifierImpl(std::function<void(int)> on_modification) {}
    ~FileModificationNotifierImpl() {}
...
class FileModificationNotifierImpl : FileModificationNotifier {
   public:
    FileModificationNotifierImpl(std::function<void(int)> on_modification)
...
std::unique_ptr<FileModificationNotifier> CreateFileModificationNotifier(
    ...
    return std::make_unique<FileModificationNotifierImpl>(on_modification);
}
